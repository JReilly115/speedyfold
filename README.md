...
5. Althernatively, you can activate your Conda environment and submit any of the scripts 01-06 contained in the "bash\_scripts" directory to isolate a specific step of SpeedyFold
