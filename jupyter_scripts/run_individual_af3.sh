...
# Output directory (changeable)
OUTPUT_BASE_DIR="/cluster/tufts/cowenlab/jreill05/AlphaFold/speedyfold/outputs/individual_outputs/test1"

# Submission json file (changeable)
